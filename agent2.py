...
ROLES = [
    {
        ...
        "resume_secret": "RESUME_DATA_ANALYST_B64",
...
STATE_FILE = "logs/processed_ids_malathi.json"
...
RESUME_FILES = {
    "RESUME_DATA_ANALYST_B64": "resume_data_analyst.b64",
}
...
def send_reply(email, role, your_name, your_email, app_password):
    ...
    fname = "Resume_Malathi_Gambiraopet.docx"
