...
I am a Senior Software Engineer with 10+ years of experience in web application development, specializing in React.js, Angular, TypeScript, JavaScript, Redux, and Azure DevOps. My expertise includes building scalable SPAs, REST API integrations, CI/CD pipelines, and responsive UI/UX design.
...
ROLES = [
    {
        ...
        "keywords": [
            "react developer", "react.js developer", "senior react developer",
            "frontend developer", "front end developer", "front-end developer",
            "ui developer", "angular developer", "angular engineer",
            "javascript developer", "typescript developer",
            "senior frontend engineer", "senior ui developer",
            "web developer", "full stack developer", "fullstack developer",
